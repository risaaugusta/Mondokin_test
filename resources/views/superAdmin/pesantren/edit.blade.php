        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Ubah Data Institusi</h6>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('superadmin.pesantren.update', $pesantren->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <a href="{{route('superadmin.pesantren.index')}}" class="btn btn-primary">
                                    Kembali
                                </a>
