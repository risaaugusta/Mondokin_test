...
@section('content')
    <form action="{{route('administrationadmin.asatidz.store')}}" method="post" enctype="multipart/form-data">
        <!-- Start Account -->
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input name="nip" type="text" class="form-control @error('nip') is-invalid @enderror" value="{{old('nip')}}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror" value="{{old('npwp')}}" required>
                                    @include('layouts.inputError', ['errorName' => 'npwp'])
                                </div>
                                <div class="form-group">
                                    <label for="ktp">KTP</label>
                                    <input name="ktp" type="text" class="form-control @error('ktp') is-invalid @enderror" value="{{old('ktp')}}" required>
                                    @include('layouts.inputError', ['errorName' => 'ktp'])
                                </div>
                                <div class="form-group text-left">
                                    <label for="religion">Agama</label>
                                    <select id="religion" name="religion" class="form-control @error('religion') is-invalid @enderror" value="{{old('religion')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="birthplace" type="text" class="form-control @error('birthplace') is-invalid @enderror" value="{{old('birthplace')}}" required>
                                    @include('layouts.inputError', ['errorName' => 'birthplace'])
                                </div>
                                <div class="form-group">
                                    <label for="birthdate">Tanggal Lahir</label>
                                    <input name="birthdate" type="date" class="form-control @error('birthdate') is-invalid @enderror" value="{{old('birthdate')}}" required>
                                    @include('layouts.inputError', ['errorName' => 'birthdate'])
                                </div>
                                <div class="form-group">
                                    <label for="additional_task">Tugas Tambahan</label>
                                    <textarea name="additional_task" id="" class="form-control @error('additional_task') is-invalid @enderror">{{old('additional_task')}}</textarea>
                                </div>
                                <div class="form-group text-left">
                                    <label for="marriage_status">Status Perkawinan</label>
                                    <select id="marriage_status" name="marriage_status" class="form-control @error('marriage_status') is-invalid @enderror" value="{{old('marriage_status')}}">
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <select id="employee_status" name="employee_status" class="form-control @error('employee_status') is-invalid @enderror" value="{{old('employee_status')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="photo" type="file" class="form-control @error('photo') is-invalid @enderror" value="{{old('photo')}}" accept="image/*" required>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            const marriageStatusOldValue = '{{ old('marriage_status') }}';
            
            if(marriageStatusOldValue !== '') {
                $('#marriage_status').val(marriageStatusOldValue);
            }

            const employeeStatusOldValue = '{{ old('employee_status') }}';
